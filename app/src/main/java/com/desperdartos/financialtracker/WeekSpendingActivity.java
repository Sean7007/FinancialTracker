...
import com.desperdartos.financialtracker.adapter.WeekSpendingAdapter;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    totalWeekAmountTextView.setText("Total Month's Spending: P" + totalAmount);
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds: snapshot.getChildren()){
                    ...
                    totalWeekAmountTextView.setText("Total Week's Spending: P"+ totalAmount);
